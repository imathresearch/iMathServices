...
def showShortHelp(command):
    if command == 'createModel':
        print "    Uso: crearModelo_Baja <fichero entrada> <clasificador> <nombre modelo>"
        print "    Ejemplo: crearModelo_Baja train_data.csv SVC SVCmodel"
        print "    Mas info: crearModelo_Baja --help"
    elif command == 'testModel':
        print "    Uso: testearModelo_Baja <fichero entrada> <nombre modelo> <fichero salida>"
        print "    Ejemplo: testearModelo_Baja train_data.csv SVCmodel result.txt"
        print "    Mas info: testearModelo_Baja --help"
    elif command == 'predictModel':
        print "    Uso: predecirModelo_Baja <fichero entrada> <nombre modelo> <fichero salida>"
        print "    Ejemplo: predecirModelo_Baja predict_data.csv SVCmodel result.txt"
        print "    Mas info: predecirModelo_Baja --help"
