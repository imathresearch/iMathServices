...
minutesForEachRoom = [15]

for minuteForEachRoom in minutesForEachRoom:

    pathFileRead = '/home/izubizarreta/Documentos/Documentos/Comercial/Sensovida/Prediccion/TesteoTodosLosDatos11Octubre.csv'
    ...
    for intervalTime in IntervalTimes:
        ...
        pathFileWriteTraining = '/home/izubizarreta/Documentos/Documentos/Comercial/Sensovida/Prediccion/TodosRegisters' + str(minuteForEachRoom) + str(intervalTime) + 'Training11Octubre.csv'
        pathFileWriteTest = '/home/izubizarreta/Documentos/Documentos/Comercial/Sensovida/Prediccion/TodosRegisters' + str(minuteForEachRoom) + str(intervalTime) + 'Test11Octubre.csv'
